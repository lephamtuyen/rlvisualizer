...
with tf.Session() as sess:
    agent = Model_DDPG(sess, actor, critic, memory, env=env, max_test_epoch=20,warm_up=50000,max_step_per_game = 25000,is_plot=True,
                 render=False, max_episode=3000, env_name=ENV_NAME,noise_theta=0.15,noise_sigma=0.1)
    agent.train()
